<script>
  import Braces from './braces.svelte'
</script>

<h1><a href="/">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 75 46" aria-labelledby="logoTitle logoDescription">
    <title id="logoTitle">juji</title>
    <title id="logoDescription">a web developer</title>
    <g fill="currentColor">
